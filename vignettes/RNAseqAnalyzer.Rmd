---
title: "RNA-SAIL: End-to-End RNA-seq Analysis Workflow"
author: "Katarina Vizar Cisarova"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{RNA-SAIL: End-to-End RNA-seq Workflow}
...
RNA-SAIL provides a complete, modular, end-to-end RNA-seq analysis workflow, integrating:
...
```{r, eval=FALSE}
devtools::install("https://github.com/OncologyMedunigraz/rna-sail")
library(rna-sail)
```
...
- Metadata: sample → condition table
...
This vignette demonstrated how to run the full RNA-SAIL pipeline and access the results. The package is designed to be modular, flexible, and publication-ready.
