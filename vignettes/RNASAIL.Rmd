---
title: "RNASAIL: End-to-End RNA-seq Analysis Workflow"
author: "Katarina Vizar Cisarova"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{RNASAIL: End-to-End RNA-seq Workflow}
...
RNASAIL provides a complete, modular, end-to-end RNA-seq analysis workflow, integrating:
...
This vignette demonstrated how to run the full RNASAIL pipeline and access the results. The package is designed to be modular, flexible, and publication-ready.
